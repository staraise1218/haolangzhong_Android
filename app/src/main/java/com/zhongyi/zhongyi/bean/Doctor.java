...
public class Doctor {
    ...
    private int consultation_times;
    private String comecost;
    private String comeflag;
    private String starlv;
    private int tiaolicount;
    ...
    public int getConsultation_times() {
        return consultation_times;
    }

    public void setConsultation_times(int consultation_times) {
    ...
    public int getTiaolicount() {
        return tiaolicount;
    }

    public void setTiaolicount(int tiaolicount) {
        this.tiaolicount = tiaolicount;
    }
