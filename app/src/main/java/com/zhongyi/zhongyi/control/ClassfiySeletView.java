package com.zhongyi.zhongyi.control;
...
//        }
       ...
       // this.setCompoundDrawablesWithIntrinsicBounds(0,0,R.mipmap.down_arrow,0);
    ...
    public void onClick(final View v) {
       ...
       // this.setCompoundDrawablesWithIntrinsicBounds(0,0,R.mipmap.dowu_blue,0);
        //
       ...
       // int height = metric.heightPixels;   // 屏幕高度（像素）
        ...
        myPopupwindow.setOnItemSelectedListener(new ClassfiySeletPopupWindow.OnItemSelectedListener() {
            ...
            public void onItemSelected(String key, String name) {
                ...
                int cateEnd = key.indexOf("t");
                String cateId = key.substring(0,cateEnd);
                int startSubCate = key.indexOf("c");
                String subCateId = key.substring(startSubCate+1,key.length());
                //TODO
                onItemClickListener.onItemClick(cateId,subCateId);
            }
        });
        ...
        myPopupwindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
               ...
               // ClassfiySeletView.this.setCompoundDrawablesWithIntrinsicBounds(0,0,R.mipmap.down_arrow,0);
            }
        });
    ...
    public interface OnItemClickListener{
        void onItemClick(String cateId, String subCateId);
    }
