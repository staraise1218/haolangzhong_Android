...
public class ZYZJ_YYHolder extends BaseViewHolder<Doctor> {
    ImageView zj_img;
    TextView zj_name;
    TextView zj_level;
    TextView zj_price;
    ...
    public ZYZJ_YYHolder(View view) {
        super(view);
    ...
    public void setData(final Doctor data) {
        ...
        zj_price.setText("￥" + data.getRegisterprice());
        zj_content.setText(data.getAgenum()+"岁  "+data.getProfessional()+"  从医"+data.getWorkyear()+"年");
        zj_memo.setText("咨询次数：" + data.getConsultation_times());
        ...
        zj_zx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                askListener.ask(data.getId(),data.getRegisterprice());
            }
        });
