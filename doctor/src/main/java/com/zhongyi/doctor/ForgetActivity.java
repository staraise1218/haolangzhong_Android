...
import com.zhongyi.doctor.bean.ask.ForgetBean;
import com.zhongyi.doctor.bean.ask.VerifCode;
import com.zhongyi.doctor.bean.temp.ForgetTemp;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.forget_btn:{
                String phone =  forget_phone_et.getText().toString().trim();
