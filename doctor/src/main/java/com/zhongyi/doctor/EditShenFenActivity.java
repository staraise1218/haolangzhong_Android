...
public class EditShenFenActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void setView() {
        setContentView(R.layout.activity_shenfen_edit);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            {
                EditShenFenActivity.this.finish();
            }
                break;
            case R.id.submit:{
                name = editText.getText().toString().trim();
                Intent intent = new Intent();
                intent.putExtra("shenfen",name);
                EditShenFenActivity.this.setResult(RESULT_OK,intent);
                EditShenFenActivity.this.finish();
            }
                break;
        }
